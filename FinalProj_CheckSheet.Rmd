...
(A) .Rmd Line numbers where at least two different data sources are imported:  36-37, 57-62


(B) .Rmd Line numbers for inspecting data intake:  42, 62, 83, 89
...
(A) .Rmd Line number(s) for general data wrangling: 49-51, 59-60, 154-156, 172-173, 191-192, 200-201, 210-212


(B) .Rmd Line number(s) for a join operation: 81-82


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 174 


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 155-156, 173, 192, 201, 212


(H) .Rmd Line number(s) for use of machine learning (not "wrangling" but scored here): 192-209
